...
public class GenerateNoWarningsSetting extends AbstractEclipseCompilerSetting<Boolean> {
    @Override
    ...
    protected void set(Boolean value, Project project) {
        getOptions(project).GENERATE_NO_WARNINGS = value;
    }
}
