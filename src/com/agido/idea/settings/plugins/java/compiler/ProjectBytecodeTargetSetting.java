...
public class ProjectBytecodeTargetSetting extends AbstractJavaCompilerSetting<String> {
    @Override
    ...
    protected String get(Project project) {
        return Compiler.getConfiguration(project).getProjectBytecodeTarget();
    }

    @Override
    protected void set(String value, Project project) {
        Compiler.getConfiguration(project).setProjectBytecodeTarget(value);
    }
}
